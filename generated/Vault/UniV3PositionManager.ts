...
export class UniV3PositionManager__positionsResult {
  value0: BigInt;
  value1: Address;
  value2: Address;
  value3: Address;
...
export class UniV3PositionManager extends ethereum.SmartContract {
  static bind(address: Address): UniV3PositionManager {
    return new UniV3PositionManager("UniV3PositionManager", address);
  }
  ...
  positions(tokenId: BigInt): UniV3PositionManager__positionsResult {
    let result = super.call(
      "positions",
    ...
    return new UniV3PositionManager__positionsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toAddress(),
  ...
  try_positions(
    tokenId: BigInt
  ): ethereum.CallResult<UniV3PositionManager__positionsResult> {
    let result = super.tryCall(
      "positions",
      "positions(uint256):(uint96,address,address,address,uint24,int24,int24,uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    return ethereum.CallResult.fromValue(
      new UniV3PositionManager__positionsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toAddress(),
